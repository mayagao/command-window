...
export const primitiveData: Record<PrimitiveType, PrimitiveItem[]> = {
  ...
  issue: [
    ...
    {
      type: "issue",
      title: "CAPI to investigate slimming down our Docker image sizes",
      number: 8224,
    },
    {
      type: "issue",
      title: "CAPI mirror traffic chatops should include mirror percentage",
      number: 8222,
    },
    {
      type: "issue",
      title: "Exchange Canonical GitHub image_urls for presigned URLs",
      number: 8171,
    },
  ],
  project: [
